    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', models.CharField(max_length=30, validators=[django.core.validators.RegexValidator('^[A-Z][a-zA-Z\\d]{0,20}$', 'Model first letter must be uppercase,  min 1 max 30 characters, digits allowed')])),
